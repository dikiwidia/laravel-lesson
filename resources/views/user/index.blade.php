                    ...
                    <tr class="hover:bg-sky-50">
                        ...
                        <td class="flex text-center px-2 py-1.5">
                            ...
                            <form class="rounded-e" method="POST" action="{{ route('user.delete', ['id' => $data->id]) }}">
                                ...
                                @csrf
                                <button
                                    class="text-sm px-2 py-1 bg-rose-400 text-slate-100 hover:bg-rose-500 cursor-pointer rounded-e disabled:bg-rose-200"
                                    {{ !$is_authed ? 'disabled' : '' }} type="submit">Hapus</button>
                            </form>
                        </td>
                    </tr>
                @empty
